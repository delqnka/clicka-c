...
import { extractHostname } from '@/lib/domain-routing';
...
// Clicka is a white-label engine, not a SaaS marketing site — the apex host
// has no public-facing marketing pages of its own. Per-salon sitemaps are
// served from each salon's own custom domain via buildSalonSitemapEntries.
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Apex host or unknown host: nothing to advertise.
  return [];
}

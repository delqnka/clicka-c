...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Въведи услугите, които предлагаш, с цени и времетраене. Клиентите ще резервират директно.',
    tab: 'Услуги',
  },
  {
    icon: '🚀',
    title: 'Публикувай сайта',
    desc: 'Натисни „Публикувай" горе вдясно и сайтът ти е жив! Можеш да го редактираш по всяко време.',
    tab: null,
  },
];
